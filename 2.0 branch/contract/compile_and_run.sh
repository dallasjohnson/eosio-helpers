...
CONTRACT_NAME=simpledb
ACCOUNT_NAME=simpledb

CONTRACT_DIR="$EOSROOTPATH/contracts/$CONTRACT_NAME"

# color_printf "Generate the ABI based on the hpp" & pause
...
# color_printf "insert key value 1"
# exe eosc push message ${ACCOUNT_NAME} insertkv1 '{"key":"firstKey3", "value":"firstvalusdfsdffsdelkjasdflkjskjlksdljkfjflkdjkljdf2" }' -S ${ACCOUNT_NAME}
# color_printf "Read it back"
# exe eosc get table ${ACCOUNT_NAME} ${ACCOUNT_NAME} keyvalue1
